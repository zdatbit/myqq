...
public class MainFrame extends JFrame
{
	...
	public MainFrame()
	{
		...
		tabbedPane.addTab("\u597D\u53CB", new ImageIcon(MainFrame.class.getResource("/img/friend_list.png")), panel好友列表, null);
		...
		menuItem发送即时消息.setIcon(new ImageIcon(MainFrame.class.getResource("/img/QQ_16.png")));
		...
		panel群 = new JPanel();
		tabbedPane.addTab("\u7FA4\u7EC4", new ImageIcon(MainFrame.class.getResource("/img/friend_qun.png")), panel群, null);
		...
		panel最近 = new JPanel();
		tabbedPane.addTab("\u6700\u8FD1", new ImageIcon(MainFrame.class.getResource("/img/friend_history.png")), panel最近, null);
		panel设置面板.setLayout(null);
		
		lbl设置 = new JLabel("");
		lbl设置.setIcon(new ImageIcon(MainFrame.class.getResource("/img/button/QQ_settings_1.png")));
		lbl设置.setBounds(6, 6, 64, 64);
		panel设置面板.add(lbl设置);
		panel用户信息.setLayout(null);
		
		lbl头像 = new JLabel("");
		lbl头像.setIcon(new ImageIcon(MainFrame.class.getResource("/img/headImage/head_boy_01_64.jpg")));
