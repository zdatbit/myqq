...
public class PublicMessageFrame extends JDialog
{
	...
	public void init(String title,String publicMessage)
	{
		...
		lbl关闭 = new JLabel("");
		lbl关闭.setIcon(new ImageIcon(PublicMessageFrame.class.getResource("/img/button/login_exit_1.png")));
		lbl关闭.setBounds(312, 0, 38, 18);
		contentPane.add(lbl关闭);
		
		lbl最小化 = new JLabel("");
		lbl最小化.setIcon(new ImageIcon(PublicMessageFrame.class.getResource("/img/button/login_minsize_1.png")));
