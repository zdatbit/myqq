...
public class QunChatFrame extends JFrame
{
	...
	public QunChatFrame()
	{
		...
		lbl头像.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/QQ_64.png")));
		lbl头像.setBounds(6, 6, 64, 64);
		panel顶部.add(lbl头像);
		
		JLabel lbl视频 = new JLabel("");
		lbl视频.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/chat/fun_video_54.png")));
		lbl视频.setBounds(82, 16, 54, 54);
		panel顶部.add(lbl视频);
		
		JLabel lbl语音 = new JLabel("");
		lbl语音.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/chat/fun_voice_54.png")));
		lbl语音.setBounds(138, 16, 54, 54);
		panel顶部.add(lbl语音);
		
		JLabel lbl发送文件 = new JLabel("");
		lbl发送文件.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/chat/fun_sendfile_54.png")));
		...
		lbl文字.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/chat/fun_font_32.png")));
		
		JLabel lbl表情 = new JLabel("");
		lbl表情.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/chat/fun_face_32.png")));
		
		JLabel lbl音乐 = new JLabel("");
		lbl音乐.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/chat/fun_music_32.png")));
		
		JLabel lbl图片 = new JLabel("");
		lbl图片.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/chat/fun_picture_32.png")));
		
		JLabel lbl截图 = new JLabel("");
		lbl截图.setIcon(new ImageIcon(QunChatFrame.class.getResource("/img/chat/fun_snap_32.png")));
