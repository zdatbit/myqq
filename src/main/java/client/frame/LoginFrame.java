...
public class LoginFrame extends JFrame
{
	...
	public LoginFrame()
	{
		...
		lbl头像 = new JLabel("");
		lbl头像.setIcon(new ImageIcon(LoginFrame.class.getResource("/img/headImage/head_boy_01_64.jpg")));
		...
		lbl登录 = new JLabel("");
		lbl登录.setIcon(new ImageIcon(LoginFrame.class.getResource("/img/button/button_login_1.png")));
		...
		lbl最小化 = new JLabel("");
		lbl最小化.setIcon(new ImageIcon(LoginFrame.class.getResource("/img/button/login_minsize_1.png")));
		lbl最小化.setBounds(284, 0, 29, 19);
		contentPane.add(lbl最小化);
		
		lbl退出 = new JLabel("");
		lbl退出.setIcon(new ImageIcon(LoginFrame.class.getResource("/img/button/login_exit_1.png")));
		lbl退出.setBounds(312, -1, 37, 20);
		contentPane.add(lbl退出);
		
		lbl多账号 = new JLabel("");
		lbl多账号.setIcon(new ImageIcon(LoginFrame.class.getResource("/img/button/login_duozhanghao_1.png")));
		lbl多账号.setBounds(14, 237, 69, 21);
		contentPane.add(lbl多账号);
		
		lbl设置 = new JLabel("");
		lbl设置.setIcon(new ImageIcon(LoginFrame.class.getResource("/img/button/login_setting_1.png")));
