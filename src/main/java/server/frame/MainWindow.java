...
public class MainWindow extends JFrame {
	...
	public MainWindow() 
	{
		...
		tabbedPane.addTab("用户管理", new ImageIcon(MainWindow.class.getResource("/img/manager_users.png")), userMana, null);
		
		msgMana=new MsgMana();
		tabbedPane.addTab("消息管理", new ImageIcon(MainWindow.class.getResource("/img/manager_message.png")), msgMana, null);
